...
void GNode::AddEvent(GNode* seg2, double rate12, const Eigen::Vector3d& dr,
                     double Jeff2, double reorg_out) {
  GLink newEvent;
...
void GNode::AddEventfromQmPair(const QMPair& pair, int carriertype,
